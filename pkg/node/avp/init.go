...
var (
	...
	factories   map[string]func(rid string, mid string, broadcast func(rid string, mid string, msg map[string]interface{}) *nprotoo.Error) *processor.Processor
...
func buildProcessorFactories(conf map[string]interface{}) map[string]func(rid string, mid string, broadcast func(rid string, mid string, msg map[string]interface{}) *nprotoo.Error) *processor.Processor {
	factories := make(map[string]func(rid string, mid string, broadcast func(rid string, mid string, msg map[string]interface{}) *nprotoo.Error) *processor.Processor)
	for k, v := range conf {
		switch k {
		case "recorder":
			recorder.Init(v.(map[string]interface{}))
			factories[k] = (func(rid string, mid string, broadcast func(rid string, mid string, msg map[string]interface{}) *nprotoo.Error) *processor.Processor)(recorder.NewRecorder)
		case "speech":
			speech.Init(v.(map[string]interface{}))
			factories[k] = (func(rid string, mid string, broadcast func(rid string, mid string, msg map[string]interface{}) *nprotoo.Error) *processor.Processor)(speech.NewSpeech)
		}
	}
	return factories
}
