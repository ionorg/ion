...
type FindNodeReply struct {
	...
	Node []*ion.Node `protobuf:"bytes,1,rep,name=node,proto3" json:"node,omitempty"`
}
...
func (x *FindNodeReply) GetNode() []*ion.Node {
	if x != nil {
		return x.Node
	}
	return nil
...
type BroadcastMsg struct {
	...
	//	*BroadcastMsg_PeerEvent
	//	*BroadcastMsg_StreamEvent
	//	*BroadcastMsg_Msg
	Payload isBroadcastMsg_Payload `protobuf_oneof:"payload"`
}
...
func (m *BroadcastMsg) GetPayload() isBroadcastMsg_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (x *BroadcastMsg) GetPeerEvent() *ion.PeerEvent {
	if x, ok := x.GetPayload().(*BroadcastMsg_PeerEvent); ok {
		return x.PeerEvent
	}
	return nil
}

func (x *BroadcastMsg) GetStreamEvent() *ion.StreamEvent {
	if x, ok := x.GetPayload().(*BroadcastMsg_StreamEvent); ok {
		return x.StreamEvent
	}
	return nil
}

func (x *BroadcastMsg) GetMsg() *ion.Message {
	if x, ok := x.GetPayload().(*BroadcastMsg_Msg); ok {
		return x.Msg
	}
	return nil
}

type isBroadcastMsg_Payload interface {
	isBroadcastMsg_Payload()
}

type BroadcastMsg_PeerEvent struct {
	PeerEvent *ion.PeerEvent `protobuf:"bytes,2,opt,name=peerEvent,proto3,oneof"`
}

type BroadcastMsg_StreamEvent struct {
	StreamEvent *ion.StreamEvent `protobuf:"bytes,3,opt,name=streamEvent,proto3,oneof"`
}

type BroadcastMsg_Msg struct {
	Msg *ion.Message `protobuf:"bytes,4,opt,name=msg,proto3,oneof"`
}

func (*BroadcastMsg_PeerEvent) isBroadcastMsg_Payload() {}

func (*BroadcastMsg_StreamEvent) isBroadcastMsg_Payload() {}

func (*BroadcastMsg_Msg) isBroadcastMsg_Payload() {}
...
var file_protos_islb_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x2e, 0x0a, 0x0d,
	0x46, 0x69, 0x6e, 0x64, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1d, 0x0a,
	0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x69, 0x6f,
	0x6e, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0xa1, 0x01, 0x0a,
	0x0c, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x4d, 0x73, 0x67, 0x12, 0x2e, 0x0a,
	0x09, 0x70, 0x65, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0x0b, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01,
	...
	0x65, 0x6e, 0x74, 0x12, 0x20, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	...
	,
...
var file_protos_islb_proto_goTypes = []interface{}{
	...
	(*BroadcastMsg)(nil),      // 2: islb.BroadcastMsg
	...
	(*ion.SessionReport)(nil), // 7: ion.SessionReport
	(*ion.Empty)(nil),         // 8: ion.Empty
}
var file_protos_islb_proto_depIdxs = []int32{
	3, // 0: islb.FindNodeReply.node:type_name -> ion.Node
	4, // 1: islb.BroadcastMsg.peerEvent:type_name -> ion.PeerEvent
	5, // 2: islb.BroadcastMsg.streamEvent:type_name -> ion.StreamEvent
	6, // 3: islb.BroadcastMsg.msg:type_name -> ion.Message
	0, // 4: islb.ISLB.FindNode:input_type -> islb.FindNodeRequest
	7, // 5: islb.ISLB.SessionReport:input_type -> ion.SessionReport
	8, // 6: islb.ISLB.Broadcast:input_type -> ion.Empty
	1, // 7: islb.ISLB.FindNode:output_type -> islb.FindNodeReply
	8, // 8: islb.ISLB.SessionReport:output_type -> ion.Empty
	2, // 9: islb.ISLB.Broadcast:output_type -> islb.BroadcastMsg
...
func file_protos_islb_proto_init() {
	...
	file_protos_islb_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*BroadcastMsg_PeerEvent)(nil),
		(*BroadcastMsg_StreamEvent)(nil),
		(*BroadcastMsg_Msg)(nil),
	}
	type x struct{}
