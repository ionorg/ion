...
cd $APP_DIR
echo "------------tar ion-----------"
tar cvzf ion.tar.gz bin/ion configs/ion.toml configs/cert.pem configs/key.pem scripts/mac/ionStart.sh scripts/mac/ionStop.sh

echo "------------tar islb-----------"
tar cvzf islb.tar.gz bin/islb configs/islb.toml configs/cert.pem configs/key.pem scripts/mac/ionStart.sh scripts/mac/ionStop.sh
